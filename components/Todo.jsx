...
const Todoo = ({id,todoName,remainedTime,completed,onChangeCondition,onTodoEdit,onTodoDelete}) => {
    return ( 
        <div className="flex justify-center items-center p-2 bg-blue-100 gap-6">
           ...
           <div className="flex gap-4">
            ...
            <Link legacyBehavior href={`/todos/${id}`} className="flex justify-center items-center"><a><AiOutlineEdit className="w-5 h-5 cursor-pointer" onClick={onTodoEdit}/></a></Link>
